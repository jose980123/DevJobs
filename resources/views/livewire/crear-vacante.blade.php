<form action="" class="md:w-1/2 space-y-5" wire:submit.prevent='crearVacante'>
    ...
    <div>
        ...
        <select wire:model="salario" id="salario" class="text-gray-600 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
    ...
    <div>
        ...
        <select wire:model="categoria" id="categoria" class="text-gray-600 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
    ...
    <div>
        ...
        <x-text-input 
            id="ultimo_dia" 
            class="block mt-1 w-full text-gray-600" 
